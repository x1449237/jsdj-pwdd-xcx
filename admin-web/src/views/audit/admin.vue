<template>
  <div class="page-container">
    <div class="page-header">
      <span class="page-title">内置管理员审核</span>
    </div>
    ...
    >
      <div v-loading="detailLoading">
        ...
        <h4 class="detail-sub-title">店铺信息</h4>
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="经营范围">{{ detailData.businessScope || '-' }}</el-descriptions-item>
          <el-descriptions-item label="营业执照">{{ detailData.businessLicense || '-' }}</el-descriptions-item>
        </el-descriptions>
  ...
  methods: {
    async fetchList() {
      ...
      try {
        ...
        console.error('获取内置管理员审核列表失败:', err)
      } finally {
        this.loading = false
      }
    },
